<tr>
    ...
    <td class="border px-4 py-2"><x-price :price="$car->price"/></td>
    <td class="border px-4 py-2">{{ (bool) $car->is_new ? 'Да' : 'Нет' }}</td>
    ...
    <td class="border px-4 py-2">
        <div class="flex items-center">
            <a href="{{ route('admin.cars.delete-car', ['car' => $car]) }}" class="inline-block bg-gray-400 hover:bg-opacity-70 focus:outline-none text-white font-bold py-2 px-4 rounded" title="Удалить">
