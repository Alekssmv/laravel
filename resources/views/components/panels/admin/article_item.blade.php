@props(['article'])
    <tr>
        ...
        <td class="border px-4 py-2">{{ implode(', ',$article->tags->pluck('name')->toArray()) }}</td>
        <td class="border px-4 py-2">
            <div class="flex items-center">
                <a href="{{ route('admin.articles.edit', compact('article')) }}"
        ...
        <td class="border px-4 py-2">
            <form class="flex items-center">
                <a href="{{ route('admin.articles.delete-article', ['article' => $article]) }}"
